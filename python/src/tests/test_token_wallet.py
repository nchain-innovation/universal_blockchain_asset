...
class TokenWalletTest(unittest.TestCase):
    ...
    def setUp(self):
        self.tw = TokenWallet()
        # This is a documented test key for the SECP256k1 curve, do not use in production
        self.tw.set_key("cU4nzixA5cDSXjGX5hcvZ8QjqZBMLGqwNoWCRZ5fwCt2NLJMyyy3", "SECP256k1")
        self.tw_nist256 = TokenWallet()
        # This is a documented test key for the NIST256p curve, do not use in production
