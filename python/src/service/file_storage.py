...
class FileStorage:
    def __init__(self, storage_dir: str = "../data/images", allowed_extensions: set = {"png", "jpg", "jpeg", "gif"}):
        ...
        self.file_data: Dict[str, Dict[str, str]] = {}   # Dictionary to store UUID, username, and file_path
    ...
    #  ----------------------------------------------------------------
    def save_file(self, file_content: bytes, filename: str, username: str) -> dict:
        ...
        try:
            ...
            return {"asset_id": unique_reference, "file_hash": file_hash}
    ...
    #  ----------------------------------------------------------------
    def get_file_data(self, unique_reference: str, username: str) -> dict:
